require = function() {
	...
	9: [function(t, e, r) {
		...
		"./defaults": 10,
		"@marcom/ac-feature/webGLAvailable": 6
	}],
	10: [function(t, e, r) {
		"use strict";
		e.exports = {
	...
	26: [function(t, e, r) {
		...
		function i(t, e, r, o) {
			...
			s(e, n) || (l && a ? u(e, n) : c ? f(e, i) : t === S ? u(e, n) : t === x && f(e, n))
		}

		function a(t, e, r, o) {
			var n = t._subscribers,
				i = n.length;
			n[i] = e, n[i + S] = r, n[i + x] = o
		}
		...
		function l(t, e) {
			t._state === E && (t._state = O, t._detail = e, y.async(p, t))
		}

		function f(t, e) {
			t._state === E && (t._state = O, t._detail = e, y.async(m, t))
		}
	...
	34: [function(t, e, r) {
		...
		function o() {
			var t = "Apple A7 GPU" === m || "Apple A8 GPU" === m || i.os.ios && i.os.version.major <= 10 || i.os.android && c();
			return !u && !t && s()
		}
		var n = t("@marcom/ac-headjs"),
			i = t("@marcom/useragent-detect"),
			a = t("@marcom/ac-feature/touchAvailable"),
			c = t("@marcom/ac-feature/isTablet"),
			s = t("@marcom/ac-feature/webGLAvailable"),
			u = t("./helpers/forcesBasicInteraction"),
			l = a() && 1024 === window.screen.width && 1366 === window.screen.height,
			f = t("@marcom/ac-gpu-reporter").GPUReporter,
			p = new f,
			m = p.getGPU();
		! function() {
			n.addTests({
				...
				"inline-video": !u,
				"ipad-pro": l,
				"enhanced-interaction": !u,
				ie: i.browser.ie,
				edge: i.browser.edge,
				"forces-basic-interaction": u
			}), n.htmlClass()
		}()
	}, {
		"./helpers/forcesBasicInteraction": 35,
		"@marcom/ac-feature/isTablet": 3,
		"@marcom/ac-feature/touchAvailable": 5,
		"@marcom/ac-feature/webGLAvailable": 6,
		"@marcom/ac-gpu-reporter": 8,
		"@marcom/ac-headjs": 14,
		"@marcom/useragent-detect": 19
	}],
	35: [function(t, e, r) {
		"use strict";
		var o = t("@marcom/useragent-detect"),
			n = t("@marcom/ac-feature/touchAvailable")(),
			i = (o.browser.ie, document.documentElement.classList.contains("aow")),
			a = t("@marcom/ac-feature/prefersReducedMotion")(),
			c = function() {
				return !n || "function" == typeof document.elementsFromPoint
			}(),
			s = function() {
				return !!n && "function" == typeof document.msElementsFromPoint
			}(),
			u = o.os.android,
			l = i || u || o.browser.ie || s || !c || a;
		e.exports = l
	}, {
		"@marcom/ac-feature/prefersReducedMotion": 4,
		"@marcom/ac-feature/touchAvailable": 5,
		"@marcom/useragent-detect": 19
	}],
	...
	"@marcom/ac-polyfills/matchMedia": [function(t, e, r) {
		...
		"matchmedia-polyfill": 33,
		"matchmedia-polyfill/matchMedia.addListener": 32
	}],
